...
public class ScheduleController {
	...
	public void ajaxWrite(@ModelAttribute ScheduleVo scheduleVo) {
		...
		String type = "";
		if(scheduleVo.getType() == null || scheduleVo.getType().isEmpty()) {
			type = scheduleVo.getType()+"기타";
		}
	...
	@ResponseBody
	public List<ScheduleVo> ajaxSelect(@RequestParam String memNo) {
		logger.info("ajax 스케줄 조회, 파라미터 memNo={}",memNo);
