	...
	<div id="paylinebigDiv">
		...
		<div id="paylineformDiv">
			<form class="form-inline" method="post" name="lineFrm" 
				...
				<input type="hidden" name="fileName" value="${fileVo.fileName }">
				<input type="hidden" name="fileSize" value="${fileVo.fileSize }">
				<input type="hidden" name="originalFileName" value="${fileVo.originalFileName }">
