...
<link rel="stylesheet" href="https://netdna.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.css" />
 <style type="text/css">
	...
	#div3{position: relative;left: 77%;top: -40px;}
		...
		<form name="searchDateFrm" method="post" class="form-inline"
			...
			<div class="form-group">
				...
				<select class="form-control" id="docType" name="docType">
					...
					<option value="2">기안서</option>
					<option value="3">업무협조전</option>
					<option value="4">보고서</option>
					<option value="5">구매품의서</option>
					<option value="6">지출품의서</option>
					<!-- 반복 끝 -->
				</select> 
...
<div id="div2">
	<button type="button" class="btn btn-primary" id="docForm">인쇄</button>
</div>
</div><br>
