...
<form action="<c:url value='/board/boardList.do'/>" name="frmPage"
	method="post">
			...
			<div class="divSearch" class="search" style="margin-left: 10px;">
				<form name="frmSearch" method="post"
					...
					<select name="searchCondition" class="form-control"
						style="width: 100px; height: 30px; font-size: 13px; display: inline-block; position: relative; top: 4px;">
						<option value="title"
		...
		<ul class="pagination justify-content-center">
			<c:if test="${pagingInfo.firstPage>1 }">
				<li class="page-item disabled"><a class="page-link"
					href="#" onclick="pageProc(${pagingInfo.firstPage-1})">previous</a></li>
			</c:if>
