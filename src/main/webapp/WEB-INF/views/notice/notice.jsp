...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
	...
	<a href="<c:url value='/notice/noticeWrite.do'/>" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
	<i class="fas fa-download fa-sm text-white-50"></i>공지사항 등록</a>
</div>
   	...
   	<form name="frmSearch" method="post" 
        ...
        <select name="searchCondition">
            ...
            <option value="category" 
            	<c:if test="${param.searchCondition=='NOTI_CATEGORY' }">
            		selected="selected"
            	</c:if>
            >부서</option>
        </select>   
