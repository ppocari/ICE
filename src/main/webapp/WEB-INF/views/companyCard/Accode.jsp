...
<div class="container-fluid">
		...
		<div class="row">
			...
			<!-- Area Chart -->
			<div class="col-xl-12 ">
				<div class="card shadow mb-4" style="height: fit-content; margin-top: 40px;">
					<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
						...
						<form action="<c:url value='/companyCard/Accode.do'/>"
							...
							<input type="hidden" name="currentPage"> <input
								...
								type="hidden" name="loc_num" value="${param.loc_num}">
						</form>
						<div class="divSearch">
									...
									<table class="table table-border table-hover" id="dynamicTable">
										...
										<tbody id="dynamicTbody">
											<c:if test="${empty list }">
												<tr>
													<td colspan="4" class="align_center">해당하는 주소가 존재하지
														않습니다.</td>
												</tr>
											</c:if>
											<c:if test="${!empty list }">
							...
							<div class="divPage">
								...
								<c:if test="${pagingInfo.lastPage < pagingInfo.totalPage }">
									<a href="#" onclick="pageProc(${pagingInfo.lastPage+1})"> <img
										src="<c:url value='/resources/img/last.JPG'/>"
										alt="다음 블럭으로 이동">
									</a>
								</c:if>
								<!--  페이지 번호 끝 -->
