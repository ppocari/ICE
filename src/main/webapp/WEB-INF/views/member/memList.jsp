	...
	<div class="row">
		...
		<div class="col-xl-12 " >
			<div class="card shadow mb-4" style="height: 500px">
				...
				<form name="memRegisterFrm" method="post" action="<c:url value='/member/memList.do?searchKeyWord=all'/> ">
					...
					<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
							<label for="department">부서별 조회</label>
							<select>
								<!-- option 반복 -->
							...
							<label for="position">직급별 조회</label>
							<select>
								<!-- option 반복 -->
							...
							<label for="hiredate1">입사일별</label>
